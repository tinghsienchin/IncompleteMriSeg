...
class sSE(nn.Module):
    def __init__(self, k_size = 3, p_size = 1):
        super().__init__()
        self.Conv1x1x1 = conv_block(2, 1, kernel = k_size, padding = p_size)
...
class UNet(nn.Module):
	...
	def __init__(self, in_channels, n_classes, base_n_filter, multi_TR = True):
		...
		self.shared_conv1 = Shared_feature(self.filters[0], self.filters[0], 2 , False)
		...
		self.shared_conv2 = Shared_feature(self.filters[1], self.filters[1], 4 , False)
		...
		self.shared_conv3 = Shared_feature(self.filters[2], self.filters[2], 4 , False)
		...
		self.shared_conv4 = Shared_feature(self.filters[3], self.filters[3], 4 , False)
		self.combine4 = Share_combine4(self.filters[2], self.filters[3])
	...
	def forward(self, input):
		...
		context1 = torch.cat((context1_1,context1_2,context1_3,context1_4),1)
		context1 = self.shared_conv1(context1)#共享特征
		...
		context2 = torch.cat((context2_1,context2_2,context2_3,context2_4),1)
		context2 = self.shared_conv2(context2)
		context2, context1_new = self.combine2(context1, context2)
		...
		context3 = torch.cat((context3_1,context3_2,context3_3,context3_4),1)
		context3 = self.shared_conv3(context3)
		context3, context2_new, context1_new = self.combine3(context2, context3, context1_new)
		print(context3.shape)
		...
		context4 = torch.cat((context4_1,context4_2,context4_3,context4_4),1)
		context4 = self.shared_conv4(context4)
		context4 = self.combine4(context3, context4, context2_new, context1_new)
		print(context4.shape)

		layer4 = torch.cat((layer4_1,layer4_2,layer4_3,layer4_4),1)
